...
bus_stops = {"anantapur": ["ballary", "chennai", "banglore", "tirupati", "goa","delhi","mumbai"],
                "ballary": ["anantapur", "chennai", "tirupati", "banglore", "goa","delhi"],
                "chennai": ["anantapur", "banglore", "ballary","banglore","delhi"],
                "delhi": ["chennai", "mumbai","banglore","goa"],
                "goa": ["mumbai","ballary","chennai"],
                "tirupati": ["goa","banglore"],
...
class main_level:
    ...
    def travel_Cost(self):
        ...
        fare=0
        if (self.boarding_Combo.get() == "anantapur","mumbai","tirupati","ballary","goa","delhi") and (self.des_Combo.get() == "tirupati","mumbai","ballary","goa","delhi"):
            t_fare=fare+70
        elif (self.boarding_Combo.get() == "goa") and (self.des_Combo.get() == "mumbai","ballary","chennai"):
            t_fare=fare+60
    ...
    def __init__(self, top=None):
        ...
        self.bus_Service.place(relx=0.14, rely=0.10, height=30, width=580)
        self.bus_Service.configure(background="#808037")
        self.bus_Service.configure(font=font18)
        self.bus_Service.configure(text="INDIAN ROAD TRAVELS")
